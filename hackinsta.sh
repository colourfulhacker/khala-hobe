...
printf "\e[1;92m  ╚═╝░░╚═╝╚══════╝░╚════╝░░╚════╝░░░░╚═╝░░░╚══════╝╚═╝░░╚═╝  \e[0m\n"
printf "\n"
printf "\e[1;77m\e[45m  Instagram Brute Forcer v1.0 Author: Jit Banerjee   \e[0m\n"
printf "\n"
}
...
default_threads="10"
read -p $'\e[1;92mThreads (Use maximum 20, Default Threads 10): \e[0m' threads
...
if [[ "$check" -gt 0 ]]; then
printf "\e[1;91mPlease, Chutiya ha kia? Bina tor service start kare attack mat kar ! Just type tor or service tor start\n\e[0m"
exit 1
fi
...
if [[ -n "$threads" ]]; then
printf "\e[1;91m [*] Ruk bas 2 second wait kar, threads shutting down...\n\e[0m"
